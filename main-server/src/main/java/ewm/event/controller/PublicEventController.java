...
public class PublicEventController {
    ...
    @GetMapping
    List<EventShortDto> getAllBy(@Validated @ModelAttribute PublicEventParam publicEventParam,
                                 HttpServletRequest request) {
        return publicEventService.getAllBy(publicEventParam, request);
    }

    @GetMapping("/{eventId}")
    EventFullDto getBy(@PathVariable long eventId, HttpServletRequest request) throws InterruptedException {
